...
class CambTTSService(TTSService):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        logger.debug(
            f"{self} initialized with voice_id: {self._voice_id}, model: {self.model_name}"
        )
    ...
    async def start(self, frame: StartFrame):
        ...
        """
        # Use model-specific sample rate if not explicitly specified at init
    ...
    async def run_tts(
        ...
        Args:
            ...
            context_id: The context ID for tracking audio frames. Defaults to None.
        ...
        try:
            ...
            # Determine the correct native sample rate for this model
            frame_sample_rate = 22050 if "flash" in self.model_name.lower() else 48000
